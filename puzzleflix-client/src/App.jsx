    ...
    return (
        <div className={`App ${theme}`}>
            <BrowserRouter>
                ...
                <footer style={{ display: "flex", flexDirection: "column", borderTop: "4px dashed var(--button-red)", padding: "2rem" }}>
                    ...
                    <p style={{ color: "var(--black)", marginTop: "1.5rem", fontWeight: 500 }}>Find source <a style={{ color: "var(--link-blue)" }} href="https://github.com/vanajmoorthy/PuzzleFlix/tree/main">here</a></p>
                </footer>
            </BrowserRouter>
        </div>
    );
